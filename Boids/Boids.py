...
ser = serial.Serial('COM8', 38400)  # open serial port
...
layout = [  [sg.Text('Flock control', font='Helvetica 18')],
            ...
            [sg.Slider(range=(0,100), default_value=20, size=(22,15), key='slider2',
             orientation='horizontal', font=('Helvetica', 12),enable_events=True)],
            [sg.Text('Centering Factor (Reciprocal)')],
            [sg.Slider(range=(1,5000), default_value=2000, size=(22,15), key='slider3',
             orientation='horizontal', font=('Helvetica', 12),enable_events=True)],
            [sg.Text('Avoid Factor (Reciprocal)')],
            [sg.Slider(range=(1,100), default_value=20, size=(22,15), key='slider4',
             orientation='horizontal', font=('Helvetica', 12),enable_events=True)],
            [sg.Text('Matching Factor (Reciprocal)')],
            [sg.Slider(range=(1,100), default_value=20, size=(22,15), key='slider5',
             orientation='horizontal', font=('Helvetica', 12),enable_events=True)],
